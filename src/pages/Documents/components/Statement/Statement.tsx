    ...
    <ScreenContainer>
      <WidthContainer className="flex flex-col justify-center items-center">
        <div className={"flex flex-col items-center mb-88 max-w-[1296px]"}>
          ...
          <p className="text-vitreus-white text-h2 mt-20 mb-24 font-thin">Privacy statement</p>
          <p className="text-compliq-middle text-ws-p1 text-center max-w-[1074px]">
            This privacy statement was last changed on October 30, 2023, last checked on October 30,
            2023, and applies to citizens and legal permanent residents of the United States.
          </p>
        </div>
...
export default withHelmet(Statement)(mainHelmet);
